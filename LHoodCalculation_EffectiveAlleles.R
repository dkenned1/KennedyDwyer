...
StatisticEffectiveAlleles=TRUE
...
HistMax=20
IntervalWidth=0.014
ObservedData=read.table("C:\\Users\\Dave\\Dropbox\\Chapter4\\R_Code\\Ae_Values.txt", sep=",", header=FALSE)
...
NucleotideDiversity=read.table("C:\\Users\\Dave\\Dropbox\\Chapter4\\R_Code\\Ae_Values.txt")
